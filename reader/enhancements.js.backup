...
// ===== TRIVIA DATA =====
const triviaData = {
  1: { postCredits: 2, scenes: ["Thor appears asking for Strange's help to find Odin", "Mordo confronts Jonathan Pangborn and steals his magic"], trivia: ["Benedict Cumberbatch performed many of his own stunts", "The Ancient One's death scene was shot in one take", "The film features over 1,000 VFX shots", "Benedict Cumberbatch performed the motion capture for Dormammu, essentially fighting himself", "The Cloak of Levitation's personality was inspired by the Magic Carpet from Disney's Aladdin"], easterEggs: ["A file Strange considers mentions a '35-year-old Air Force Colonel who crushed his spine in experimental armor'—a reference to James Rhodes (War Machine) in Civil War"], connections: ["Thor: Ragnarok", "Avengers: Infinity War"], stanLeeCameo: "Seen on a bus, laughing while reading Aldous Huxley's 'The Doors of Perception' as Strange and Mordo smash into the window during the mirror dimension chase" },
  2: { postCredits: 2, scenes: ["Adrian Toomes protects Spider-Man's identity in prison", "Captain America's patience PSA (joke scene)"], trivia: ["Tom Holland did his own stunts including the Washington Monument climb", "The film has over 2,800 VFX shots", "Donald Glover's character is Miles Morales' uncle in the comics", "Tom Holland went undercover at a Bronx high school for three days using a fake name and accent", "The title 'Homecoming' refers to both the school dance and Spider-Man's return to the MCU"], easterEggs: ["The mask Peter wears during the ATM robbery is a reference to the 1960s Spider-Man cartoon and the 'Pointy-Finger' meme"], connections: ["Avengers: Endgame", "Spider-Man: Far From Home"], stanLeeCameo: "Plays a neighbor named Gary who yells out of a window at Peter Parker after Peter accidentally disturbs the neighborhood" },
  3: { postCredits: 2, scenes: ["Thor and Loki's ship is approached by a massive vessel (Thanos)", "Grandmaster faces angry revolutionaries"], trivia: ["80% of the dialogue was improvised", "Taika Waititi voiced Korg via motion capture", "The film was inspired by 1980s sci-fi aesthetics", "The 'help me' play scene was Chris Hemsworth's idea"], easterEggs: ["The faces on the Grandmaster's palace tower feature past champions including Beta Ray Bill and Man-Thing"], connections: ["Avengers: Infinity War", "Thor: Love and Thunder"], stanLeeCameo: "Plays the intergalactic barber on Sakaar who uses a terrifying spinning-blade contraption to cut Thor's hair" },
  4: { postCredits: 2, scenes: ["T'Challa reveals Wakanda's true nature to the UN", "Bucky Barnes awakens in Wakanda"], trivia: ["First superhero film nominated for Best Picture at the Oscars", "Wakandan language is based on Xhosa", "The film won 3 Academy Awards", "Xhosa was chosen because John Kani (T'Chaka) is South African and speaks it fluently", "The South Korea car chase used a real Lexus LC 500, but Black Panther on top was CGI"], easterEggs: ["Shuri calls Everett Ross 'another broken white boy for us to fix,' referencing Bucky Barnes who was already in Wakanda"], connections: ["Avengers: Infinity War", "Black Panther: Wakanda Forever"], stanLeeCameo: "Appears in the South Korean casino as a 'thirsty' gambler who takes T'Challa's unclaimed winnings from the craps table" },
  5: { postCredits: 1, scenes: ["Valentina Allegra de Fontaine recruits Yelena to kill Hawkeye"], trivia: ["Set between Civil War and Infinity War", "Florence Pugh did 90% of her own stunts", "The Red Room was inspired by real Soviet programs", "Florence Pugh's landing pose was an ad-libbed joke that became a recurring gag about Natasha's 'superhero pose'", "Only film in the tracker to take place in the past but be released after the Infinity Saga"], easterEggs: ["The red 'Crimson Dynamo' action figure Red Guardian plays with is a nod to a famous Iron Man villain"], connections: ["Hawkeye", "Thunderbolts*"], stanLeeCameo: null },
  6: { postCredits: 2, scenes: ["Scott enters the Quantum Realm as the Pym family is dusted", "Giant ant plays drums (joke scene)"], trivia: ["Michelle Pfeiffer's de-aging used no CGI, only makeup", "The film has over 2,000 VFX shots", "Paul Rudd improvised many of his lines", "Most 'macro' shots of ants and small objects were filmed using specialized lenses", "The film takes place over just 48-72 hours, ending exactly as the Snap happens"], easterEggs: ["In the Quantum Realm scenes, you can briefly see a microscopic city, believed to be Chronopolis"], connections: ["Avengers: Endgame", "Ant-Man and the Wasp: Quantumania"], stanLeeCameo: "A pedestrian whose car is accidentally shrunk by a shrinking disk; he quips, 'Well, the '60s were fun, but now I'm paying for it'" },
  7: { postCredits: 1, scenes: ["Nick Fury sends a distress signal to Captain Marvel before being dusted"], trivia: ["Largest cast in MCU history at the time", "Robert Downey Jr. kept food hidden on set and ate during takes", "The Snap was filmed with actors not knowing who would be dusted", "Many actors were given fake scripts to prevent spoilers; Tom Holland wasn't told who he was fighting in certain scenes", "First film shot entirely using IMAX digital cameras"], easterEggs: ["The 'arrested development' blue man in the Collector's collection is a nod to the Russo Brothers' work on the sitcom Arrested Development"], connections: ["Avengers: Endgame", "Captain Marvel"], stanLeeCameo: "The school bus driver for Peter Parker's class who asks the kids, 'What's the matter with you kids? You never seen a spaceship before?'" },
  8: { postCredits: 0, scenes: ["No traditional post-credits scene, only the sound of Tony forging his first armor"], trivia: ["Highest-grossing film of all time (briefly)", "The final battle scene took 3 months to film", "Robert Downey Jr. improvised 'I am Iron Man'", "Over 3,000 VFX shots in the film", "Tony Stark's death scene was filmed in a studio next to where RDJ first screen-tested for Iron Man in 2007", "At 3 hours and 1 minute, it remains the longest MCU film"], easterEggs: ["When Steve and Tony travel to 1970, a helmet on a desk is the original 'Ant-Man' helmet from the comics"], connections: ["Spider-Man: Far From Home", "Loki", "WandaVision"], stanLeeCameo: "His final MCU cameo; appears via de-aging CGI as a 1970s hippie driving past Camp Lehigh, shouting, 'Hey man, make love, not war!'" },
  9: { postCredits: 2, scenes: ["Mysterio reveals Spider-Man's identity to the world", "Nick Fury is revealed to be Talos; real Fury is in space"], trivia: ["First MCU film set after Endgame", "Jake Gyllenhaal performed his own stunts", "The illusion sequences used practical effects and CGI", "The 'Peter Tingle' was the production's internal name for Spider-Sense, which they kept in the final script", "First MCU movie where Peter Parker's secret identity is officially outed to the public"], easterEggs: ["A tribute to the fallen Avengers (Tony, Steve, Natasha, Vision) is shown at the start to the tune of 'I Will Always Love You'"], connections: ["Spider-Man: No Way Home", "Secret Invasion"], stanLeeCameo: null },
  10: { postCredits: 1, scenes: ["Wanda studies the Darkhold in astral form while hearing her children"], trivia: ["Each episode mimics a different sitcom era", "Elizabeth Olsen studied classic sitcoms for months", "The show has over 300 VFX shots per episode", "Paul Bettany finally got to act with himself as Vision and White Vision", "The first episode was filmed in front of a live studio audience to capture authentic sitcom laughter"], easterEggs: ["The commercials in each episode represent Wanda's past traumas, such as the Stark Industries toaster (the bomb that hit her home)"], connections: ["Doctor Strange in the Multiverse of Madness", "Agatha: Darkhold Diaries"], stanLeeCameo: null },
  11: { postCredits: 1, scenes: ["Sharon Carter is pardoned and reinstated, but immediately calls someone to sell government secrets"], trivia: ["Anthony Mackie did his own stunts including the opening helicopter sequence", "The show explores PTSD and racial issues in America", "Isaiah Bradley's story is based on the Tuskegee experiments", "Zemo's nightclub dance scene became a viral meme, leading Marvel to release a one-hour loop version"], easterEggs: ["The 'Big Three' (Androids, Aliens, and Wizards) becomes a recurring joke for how Sam and Bucky classify threats"], connections: ["Captain America: Brave New World", "Thunderbolts*"], stanLeeCameo: null },
  12: { postCredits: 1, scenes: ["Full 'Rogers: The Musical' performance"], trivia: ["Hailee Steinfeld did her own archery training", "The show was filmed during the COVID-19 pandemic", "Lucky the Pizza Dog is based on the comics character", "Lucky is played by a real dog named Jolt, though her 'missing eye' was added via CGI"], easterEggs: ["Kate Bishop's purple suit is a direct recreation of her design from the 2012 Matt Fraction comic run"], connections: ["Echo", "Daredevil: Born Again"], stanLeeCameo: null },
  13: { postCredits: 2, scenes: ["Wong, Bruce Banner, and Carol Danvers analyze the Ten Rings", "Xialing takes over her father's organization"], trivia: ["Simu Liu did 95% of his own stunts", "The bus fight scene was shot in one continuous take", "The Ten Rings' origin remains a mystery", "Simu Liu was cast after tweeting at Marvel in 2014 asking 'are we going to talk about Shang-Chi or what?'"], easterEggs: ["Trevor Slattery (the 'fake' Mandarin from Iron Man 3) returns as a comedic hostage and guide"], connections: ["The Marvels", "Shang-Chi 2"], stanLeeCameo: null },
  ...
  17: { postCredits: 2, scenes: ["Eddie Brock returns to his universe, leaving a Venom symbiote behind", "Doctor Strange in the Multiverse of Madness trailer"], trivia: ["Kept the three Spider-Men secret until release", "Andrew Garfield lied about his involvement for months", "The film grossed over $1.9 billion worldwide", "Tom Holland cried when he first saw Tobey and Andrew in costume", "Andrew Garfield had to lie to everyone, including Emma Stone, about his involvement for over a year", "The film features five villains from two different Spider-Man franchises"], easterEggs: ["Venom (Eddie Brock) is at a bar in Mexico; he is pulled back to his universe but leaves a small piece of the symbiote behind"], connections: ["Doctor Strange in the Multiverse of Madness", "Venom 3"], stanLeeCameo: null },
  18: { postCredits: 2, scenes: ["Clea recruits Strange to fix an incursion", "Strange develops a third eye (joke scene)"], trivia: ["Sam Raimi's first superhero film since Spider-Man 3", "The film features the most variants of any MCU film", "John Krasinski appears as Reed Richards", "Bruce Campbell has his traditional Sam Raimi cameo", "Director Sam Raimi brought his signature 'horror' style to the MCU, including a scene of a zombified Strange"], easterEggs: ["The Illuminati members include Professor X (with the 90s cartoon theme music) and Reed Richards"], connections: ["Loki Season 2", "Avengers: Secret Wars"], stanLeeCameo: null },
  ...
  20: { postCredits: 1, scenes: ["Shuri meets T'Challa's son in Haiti"], trivia: ["Tribute to Chadwick Boseman throughout the film", "Namor speaks Mayan language", "Rihanna returned to music for the soundtrack", "The film was rewritten after Boseman's passing", "Namor's character was changed from 'Atlantis' to 'Talokan' to draw from Mayan and Aztec mythology"], easterEggs: [], connections: ["Ironheart", "Wakanda series"], stanLeeCameo: null },
  ...
  22: { postCredits: 1, scenes: ["Deadpool shows a clip from the TVA archives proving Johnny Storm (Human Torch) actually said the insults Deadpool claimed he did"], trivia: ["First R-rated MCU film", "Hugh Jackman returns as Wolverine after Logan", "Integrates Fox's X-Men universe into MCU", "Ryan Reynolds and Hugh Jackman improvised extensively"], easterEggs: ["Multiple 'dead' Fox-universe characters return, including Blade, Elektra, and Gambit"], connections: ["Avengers: Secret Wars", "X-Men reboot"], stanLeeCameo: null },
  23: { postCredits: 2, scenes: ["Expected to feature a setup for the Thunderbolts team formation"], trivia: ["Anthony Mackie's first film as Captain America", "Harrison Ford debuts as Thunderbolt Ross/Red Hulk", "Features the Serpent Society as villains", "Tim Blake Nelson returns as The Leader", "Harrison Ford joins the MCU, replacing the late William Hurt as Thaddeus Ross"], easterEggs: [], connections: ["Thunderbolts*", "World War Hulk"], stanLeeCameo: null },
  24: { postCredits: 2, scenes: ["Details TBD - Film not yet released"], trivia: ["The asterisk in the title is intentional and mysterious", "Features anti-heroes and reformed villains", "Florence Pugh returns as Yelena Belova", "Sebastian Stan returns as Bucky Barnes", "The asterisk implies the team might eventually change their name (rumored to be the 'Dark Avengers')"], easterEggs: [], connections: ["Captain America: Brave New World", "Avengers: Doomsday"], stanLeeCameo: null },
